...
L["3h"] = true;
L["5h"] = true;
L["Enable class specific pre-click macros.\n|cffff7d0aDruid: |r Handle flight forms.\n|cffabd473Hunter: |rHandle cheetah and pack aspects."] = true;
...
L["Select the Data Broker icon."] = true;
L["Select Icon"] = true;
L["Found %d icon"] = true;
...
L["Enable the current companion on the Data Broker display."] = true;
L["Add the current companion icon before the name."] = true;
L["Enable the current mount on the Data Broker display."] = true;
