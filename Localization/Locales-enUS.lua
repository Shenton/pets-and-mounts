...
L["For Hunters it handles Aspect of the Cheetah/Pack and Aspect of the Hawk/Iron Hawk when moving. In combat you have to use a modifier to switch to Aspect of the Cheetah/Pack."] = true;
